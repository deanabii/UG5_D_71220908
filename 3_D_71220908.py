...
while True:
    ...
    tinggi_awal = awal * math.tan(math.radians(ke5))
    jarak_akhir = awal * math.tan(math.radians(ke6)) - math.tan(math.radians(ke5))
    selisih = jarak_akhir * math.tan(math.radians(ke6))
